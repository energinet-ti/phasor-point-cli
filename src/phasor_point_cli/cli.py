    ...
    def __init__(  # noqa: PLR0915 - Complex initialization with validation, to be refactored
        ...
        if env_port:
            try:
                ...
                print("   python -m phasor_point_cli setup  # to configure database settings")
                sys.exit(1)
        ...
        if missing_creds:
            ...
            print("   python -m phasor_point_cli --username USER --password PASS [command]")
            print("\n" + "=" * 70)
            print("For more info: python -m phasor_point_cli --help")
            print("=" * 70 + "\n")
            sys.exit(1)
